...
export default function AlgebraTwoLesson() {
  ...
  const moduleLessons =
    getAlgebraTwoLessonsByModule(moduleNumber);
  ...
  function handleBackToModule() {
    navigate(
      `/library/high-school/algebra-2/module/${moduleNumber}`
    );
  }
  ...
  function handlePrevious() {
    ...
    navigate(
      `/library/high-school/algebra-2/module/${moduleNumber}/lesson/${previousLesson.lessonNumber}`
    );
  }
  ...
  function handleNext() {
    ...
    navigate(
      `/library/high-school/algebra-2/module/${moduleNumber}/lesson/${nextLesson.lessonNumber}`
    );
  }
      ...
      <Breadcrumbs
        items={[
          ...
          },
          {
            ...
            to: `/library/high-school/algebra-2/module/${moduleNumber}`,
          },
          {
            label:
              `Lesson ${rawLesson.lessonNumber}: ${rawLesson.title}`,
          },
        ]}
      />
